...
title: "GISAID - EpiPox"
vignette: >
  %\VignetteIndexEntry{GISAID - EpiPox}
...
optional_attributes_df <- read.csv("./data/pox_metadata_optional_fields.csv", header=TRUE)

...
schema = DataFrameSchema(
	...
	coerce=False,
	strict="filter",
	name="biosample_package_MIMS.me.air.6.0_schema",
	ordered=False,
	unique=None,
	report_duplicates="all",
	unique_column_names=True,
	add_missing_columns=False,
	title="BioSample package MIMS.me.air.6.0 schema",
	description="Schema validation for BioSample database using MIMS.me.air.6.0 package.",
)
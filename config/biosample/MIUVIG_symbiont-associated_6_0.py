...
Terms from other OBO ontologies are permissible as long as they reference mass/volume nouns (e.g., air, water, blood) and not discrete, countable entities (e.g., intestines, heart)",
	...
	coerce=False,
	strict="filter",
	name="biosample_package_MIUVIG.symbiont-associated.6.0_schema",
	ordered=False,
	unique=None,
	report_duplicates="all",
	unique_column_names=True,
	add_missing_columns=True,
	title="BioSample package MIUVIG.symbiont-associated.6.0 schema",
	description="Schema validation for BioSample database using MIUVIG.symbiont-associated.6.0 package.",
)
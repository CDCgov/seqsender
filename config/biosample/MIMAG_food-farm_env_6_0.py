...
schema = DataFrameSchema(
	...
	coerce=False,
	strict="filter",
	name="biosample_package_MIMAG.food-farm_env.6.0_schema",
	ordered=False,
	unique=None,
	report_duplicates="all",
	unique_column_names=True,
	add_missing_columns=False,
	title="BioSample package MIMAG.food-farm_env.6.0 schema",
	description="Schema validation for BioSample database using MIMAG.food-farm_env.6.0 package.",
)
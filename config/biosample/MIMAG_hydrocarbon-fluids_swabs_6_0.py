...
schema = DataFrameSchema(
	columns={
		...
		"bs-samp_collect_point": Column(
			...
			coerce=False,
			required=True,
			description="Sampling point on the asset where sample was collected, e.g., well, test well, drilling rig, wellhead, separator, storage tank",
		...
		"bs-biocide_admin_method": Column(
			dtype="object",
			checks=None,
			nullable=True,
			unique=False,
		...
		"bs-samp_preserv": Column(
			...
			coerce=False,
			required=False,
			description="Preservative added to the sample, e.g. Rnalater, alcohol, formaldehyde. Where appropriate include volume added, e.g. Rnalater; 2 ml",
	...
	coerce=False,
	strict="filter",
	name="biosample_package_MIMAG.hydrocarbon-fluids_swabs.6.0_schema",
	ordered=False,
	unique=None,
	report_duplicates="all",
	unique_column_names=True,
	add_missing_columns=False,
	title="BioSample package MIMAG.hydrocarbon-fluids_swabs.6.0 schema",
	description="Schema validation for BioSample database using MIMAG.hydrocarbon-fluids_swabs.6.0 package.",
)
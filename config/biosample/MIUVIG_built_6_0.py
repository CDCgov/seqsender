...
schema = DataFrameSchema(
	columns={
		...
		"bs-virus_enrich_appr": Column(
			...
			coerce=False,
			required=True,
			description="Approach used to enrich the sample for viruses, if any. If more than one approach was used, include multiple âvirus_enrich_apprâ fields.",
	...
	coerce=False,
	strict="filter",
	name="biosample_package_MIUVIG.built.6.0_schema",
	ordered=False,
	unique=None,
	report_duplicates="all",
	unique_column_names=True,
	add_missing_columns=True,
	title="BioSample package MIUVIG.built.6.0 schema",
	description="Schema validation for BioSample database using MIUVIG.built.6.0 package.",
)
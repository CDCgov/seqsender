...
schema = DataFrameSchema(
	...
	coerce=False,
	strict="filter",
	name="biosample_package_MIUVIG.food-human_foods.6.0_schema",
	ordered=False,
	unique=None,
	report_duplicates="all",
	unique_column_names=True,
	add_missing_columns=True,
	title="BioSample package MIUVIG.food-human_foods.6.0 schema",
	description="Schema validation for BioSample database using MIUVIG.food-human_foods.6.0 package.",
)
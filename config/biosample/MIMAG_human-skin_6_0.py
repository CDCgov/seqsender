...
schema = DataFrameSchema(
	columns={
		...
		"bs-dominant_hand": Column(
			dtype="object",
			checks=Check.str_matches(r"(?i)(\W|^)(left|right|ambidextrous)(\W|$)"),
			nullable=True,
			unique=False,
			coerce=False,
			required=False,
		...
		"bs-time_since_last_wash": Column(
			dtype="object",
			checks=None,
			nullable=True,
			unique=False,
	...
	coerce=False,
	strict="filter",
	name="biosample_package_MIMAG.human-skin.6.0_schema",
	ordered=False,
	unique=None,
	report_duplicates="all",
	unique_column_names=True,
	add_missing_columns=False,
	title="BioSample package MIMAG.human-skin.6.0 schema",
	description="Schema validation for BioSample database using MIMAG.human-skin.6.0 package.",
)
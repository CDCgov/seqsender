...
schema = DataFrameSchema(
	...
	coerce=False,
	strict="filter",
	name="biosample_package_MIMARKS.survey.hydrocarbon-fluids_swabs.6.0_schema",
	ordered=False,
	unique=None,
	report_duplicates="all",
	unique_column_names=True,
	add_missing_columns=False,
	title="BioSample package MIMARKS.survey.hydrocarbon-fluids_swabs.6.0 schema",
	description="Schema validation for BioSample database using MIMARKS.survey.hydrocarbon-fluids_swabs.6.0 package.",
)
...
schema = DataFrameSchema(
	columns={
		...
		"bs-nose_mouth_teeth_throat_disord": Column(
			dtype="object",
			checks=None,
			nullable=True,
			unique=False,
		...
		"bs-time_last_toothbrush": Column(
			dtype="object",
			checks=None,
			nullable=True,
			unique=False,
	...
	coerce=False,
	strict="filter",
	name="biosample_package_MIMAG.human-oral.6.0_schema",
	ordered=False,
	unique=None,
	report_duplicates="all",
	unique_column_names=True,
	add_missing_columns=False,
	title="BioSample package MIMAG.human-oral.6.0 schema",
	description="Schema validation for BioSample database using MIMAG.human-oral.6.0 package.",
)
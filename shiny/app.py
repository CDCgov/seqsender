...
header = (
    ui.card_header(
        ui.HTML(
            """<p><strong>Beta Version</strong>: 1.3.93. This pipeline is currently in Beta testing, and issues could appear during submission. Please use it at your own risk. Feedback and suggestions are welcome!</p>"""
        )
    ),
)
############## FOOTER #######################
